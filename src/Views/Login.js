			...
			<div className="login_container">
				...
				<form>
					...
					<p>
						...
						Please see our Privacy Notice, our Cookies Notice and our interest Bassed Ads Notice
					</p>
					<button className='login_registerButton' onClick={register}>Create your Amanaz account</button>
			</div>
		</div>
	)
}
